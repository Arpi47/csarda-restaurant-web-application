...
export default function Profile() {
    ...
    async function loadProfile() {
        try {
            ...
            setUser(data);
            setDeleteRequested(data.deletion_requested ?? false);
            setFormData({
    ...
    async function handleDisconnectGoogle() {
        if (!confirm(t("profile.google_disconnect_confirm"))) {
            return;
        }
        try {
                        ...
                        >
                            ...
                            >
                                {user.google_connected
                                    ...
                                    : t(
                                          "profile.google_not_connected_description",
                                      )}
                            </p>
                            {user.google_connected ? (
                                <div
                                ...
                                <button
                                    type="button"
                                    onClick={() => {
                                        window.location.href = `${import.meta.env.VITE_BACKEND_URL}/auth/google/link?token=${encodeURIComponent(token)}`;
                                    }}
                                    className="
                                        w-full
                                        rounded-full

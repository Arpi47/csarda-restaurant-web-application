...
<div class="content">
    ...
    @endif
    <form method="POST" action="{{ route('user.profile.update') }}" enctype="multipart/form-data" class="reservation-form" id="user-edit-form">
        @csrf
        @method('PUT')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function(e){
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('{{ env('RECAPTCHA_SITE_KEY') }}', {action: 'edit_profile'}).then(function(token) {

    ...
    <label>
        ...
        <select name="admin_id">
            ...
            @foreach($admins as $adminOption)
                <option value="{{ $adminOption->id }}" {{ isset($admin_id) && $admin_id == $adminOption->id ? 'selected' : '' }}>
                    {{ $adminOption->name }}
                </option>
            @endforeach
        </select>
    ...
    <div class="filter-buttons">
        <button type="submit" class="btn btn-filter" title="{{ __('messages.filter') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-funnel" viewBox="0 0 16 16">
                <path d="M1.5 1.5A.5.5 0 0 1 2 1h12a.5.5 0 0 1 .39.81L10 7.18v6.64a.5.5 0 0 1-.79.41l-2-1.5a.5.5 0 0 1-.21-.41V7.18L1.11 1.81A.5.5 0 0 1 1.5 1.5z"/>
            </svg>
        </button>

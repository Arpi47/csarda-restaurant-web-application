...
@section('content') <h1>{{ __('messages.edit_category') }}</h1>
    <form id="category-form" class="admin-multilingual-form" method="POST"
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name_{{ $langKey }}" id="name_{{ $langKey }}"
                            value="{{ old('name_' . $langKey, $category->{'name_' . $langKey}) }}"
